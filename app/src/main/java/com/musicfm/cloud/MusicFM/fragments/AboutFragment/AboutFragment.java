package com.musicfm.cloud.MusicFM.fragments.AboutFragment;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if (SplashActivity.tf4 != null) {
            ...
            fragTitle.setTypeface(com.musicfm.cloud.MusicFM.activities.SplashActivity.tf4);
        }
        ...
        if (HomeActivity.isReloaded) {
            ...
            bottomMarginLayout.getLayoutParams().height = com.musicfm.cloud.MusicFM.utilities.CommonUtils.dpTopx(65, getContext());
        }
